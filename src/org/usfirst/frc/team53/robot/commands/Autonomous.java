...
public class Autonomous extends CommandGroupX {
	private static final double BUMP_DELTA = 2.2; // jumper in
	private static final double NO_BUMP_DELTA = 1.7; // jumper out
	public Autonomous() {
		/*
		...
		*/	
		...
		addSequential(new Command() {
			...
			protected void initialize() {				
				...
				Robot.driveTrain.setSetpoint(Robot.driveTrain.mGyro.getAngle());
				mStartTime = Timer.getFPGATimestamp();
			}
			@Override
			protected void execute() { Robot.driveTrain.mecanumDrivePID(0, -0.8);}			
			@Override
